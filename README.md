...
Replacement for Windows's ETA of battery lifetime.
...
- Fix lightning bolt color (currently it's yellow)
...
- (older task) calculate annual capacity loss and determined battery capacity (not necessary since batteries can tell by themself what's their full capacity and design one)
- that's mainly all
